// Activity popup
    ...
    document.getElementById('backToThumbnails').addEventListener('click', () => {
      ...
      document.querySelector('.weeks-grid').style.display = 'grid';
    });
    // MOBILE MENU
    ...
    document.addEventListener("keydown", function(e) {
      if (e.key === "Escape") {
        document.querySelectorAll(".activity-overlay,.modal").forEach(o => o.style.display = "none");
      }
    });
    ...
    modal.onclick = function(e) { if (e.target === this) modal.classList.remove('active'); }
